...
class ExceptionPayloadBuilderTest extends TestCase
{
    use ClockMockTrait;
    ...
    // -------------------------------------------------------------------------
    // ExceptionPayloadBuilder unit tests
    // -------------------------------------------------------------------------

    public function testBuildExceptionListFromString(): void
    {
        $result = ExceptionPayloadBuilder::buildExceptionList('something went wrong');
    ...
    public function testBuildExceptionListFromThrowable(): void
    {
    ...
    {
        $reflector = new \ReflectionClass(ExceptionPayloadBuilder::class);
    ...
    public function testChainedExceptionsProduceMultipleEntries(): void
    {
        ...
        $result = ExceptionPayloadBuilder::buildExceptionList($outer);
...
PHP;
        ...
        try {
            ...
            $exceptionList = ExceptionPayloadBuilder::buildExceptionList($exception);
            $payload = json_encode([
                'batch' => [[
                    'event' => '$exception',
