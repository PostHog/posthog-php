    ...
    public function testIsFeatureEnabled($response)
    {
        ...
        $this->assertEquals(
            ...
            array(
                ...
                1 => array(
                    "path" => "/flags/?v=2",
                    "payload" => sprintf('{"token":"%s","distinct_id":"user-id","groups":{},"person_properties":{"distinct_id":"user-id"},"group_properties":{},"geoip_disable":false,"flag_keys_to_evaluate":["having_fun"]}', self::FAKE_API_KEY),
    ...
    public function testIsFeatureEnabledCapturesFeatureFlagCalledEventWithAdditionalMetadata()
    {
        $this->executeAtFrozenDateTime(new \DateTime('2022-05-01'), function () {
            ...
            $this->assertEquals(
                ...
                0 => array(
                    "path" => "/flags/?v=2",
                    "payload" => sprintf('{"token":"%s","distinct_id":"user-id","groups":{},"person_properties":{"distinct_id":"user-id"},"group_properties":{},"geoip_disable":false,"flag_keys_to_evaluate":["simple-test"]}', self::FAKE_API_KEY),
                    "extraHeaders" => array(0 => 'User-Agent: posthog-php/' . PostHog::VERSION),
                        "requestOptions" => array("timeout" => 3000, "shouldRetry" => false),
                    ),
                1 => array(
        ...
        $this->assertEquals(
            ...
            array(
                ...
                1 => array(
                    "path" => "/flags/?v=2",
                    "payload" => sprintf(
                        '{"token":"%s","distinct_id":"user-id","groups":{"company":"id:5"},"person_properties":{"distinct_id":"user-id"},"group_properties":{"company":{"$group_key":"id:5"}},"geoip_disable":false,"flag_keys_to_evaluate":["having_fun"]}',
                        self::FAKE_API_KEY
                    ),
                    "extraHeaders" => array(0 => 'User-Agent: posthog-php/' . PostHog::VERSION),
                    "requestOptions" => array("timeout" => 3000, "shouldRetry" => false),
    ...
    public function testGetFeatureFlag($response)
    {
        ...
        $this->assertEquals(
            ...
            array(
                ...
                1 => array(
                    "path" => "/flags/?v=2",
                    "payload" => sprintf('{"token":"%s","distinct_id":"user-id","groups":{},"person_properties":{"distinct_id":"user-id"},"group_properties":{},"geoip_disable":false,"flag_keys_to_evaluate":["multivariate-test"]}', self::FAKE_API_KEY),
                    "extraHeaders" => array(0 => 'User-Agent: posthog-php/' . PostHog::VERSION),
                    "requestOptions" => array("timeout" => 3000, "shouldRetry" => false),
                ),
            )
        ...
        $this->assertEquals(
            ...
            array(
                ...
                1 => array(
                    "path" => "/flags/?v=2",
                    "payload" => sprintf(
                        '{"token":"%s","distinct_id":"user-id","groups":{"company":"id:5"},"person_properties":{"distinct_id":"user-id"},"group_properties":{"company":{"$group_key":"id:5"}},"geoip_disable":false,"flag_keys_to_evaluate":["multivariate-test"]}',
                        self::FAKE_API_KEY
                    ),
                    "extraHeaders" => array(0 => 'User-Agent: posthog-php/' . PostHog::VERSION),
                    "requestOptions" => array("timeout" => 3000, "shouldRetry" => false),
